...
### 1. Launch Amazone Linux AMI EC2 instance in AWS
...
```sh
aws s3 mb s3://vijay-k8s.in --region us-east-1
```
### 6. Create private hosted zone in AWS Route53
 1. Head over to aws Route53 and create hostedzone
 2. Choose name for example (vijay-k8s.in)
...
```sh
export KOPS_CLUSTER_NAME=vijay-k8s.in
export KOPS_STATE_STORE=s3://vijay-k8s.in
```
